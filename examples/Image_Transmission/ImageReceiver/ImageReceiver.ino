...
#define BIT_DURATION 100000  // 250ms in microseconds
#define AVG_WINDOW 10  // Number of samples for running average
#define LOW_FREQ_THRESHOLD 500  // Hz threshold for low frequency (adjustable)
#define HIGH_FREQ_THRESHOLD 1100  // Hz threshold for high frequency (adjustable)
...
void initializeSDCard() {
    ...
    if (SD.exists(RECEIVED_FILE)) {
        SD.remove(RECEIVED_FILE);
    }
    sdInitialized = true;
